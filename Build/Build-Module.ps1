...
Import-Module "$env:PROJECTROOT/SteamPS"
...
New-ExternalHelp -Path "$env:PROJECTROOT/docs/" -OutputPath "$env:PROJECTROOT/SteamPS/en-US"

Copy-Item -Path "$env:PROJECTROOT/SteamPS" -Destination $env:BUILTMODULEPATH -Recurse -PassThru |
